...
import { assets } from '../assets/assets';
 const Hero = () => {
  ...
  return (
    ...
    <div className= 'text-center mb-6'>   
        ...
        <p className='mt-4 max-w-xs sm:max-w-lg 2xl:max-w-xl m-auto max-sm:text-xs text-gray-600'>
            Transform your content creation with our suit of premium 
  ...
  <button
    className="bg-white px-10 py-3 rounded-lg border border-gray-300 hover:scale-105 active:scale-95 transition-transform cursor-pointer"
  >
    Watch demo
  </button>
</div>
